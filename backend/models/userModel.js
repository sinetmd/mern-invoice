...
const userSchema = new Schema(
  {
    ...
    password: {
      ...
      validate: [
        ...
        "Please must be at least 8 characters long, with at least 1 uppercase and lowercase letters and at least 1 symbol",
      ],
    },
    passwordConfirm: {
      type: String,
...
userSchema.pre("save", async function (next) {
  ...
  // i don't need to store this filed in to db
