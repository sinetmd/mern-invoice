...
const ProfilePage = () => {
  ...
  const deleteHandler = async (e) => {
    ...
    try {
      ...
      dispatch(logOut());
      toast.success("Your account has been deleted. Sad to see you go 🖐️");
    } catch (error) {
  ...
  return (
    <Container
      component="main"
      maxWidth="md"
      sx={{ border: "2px solid #e4e5e7", borderRadius: "25px", py: 2, mt: 12 }}
    >
      <CssBaseline />
      <Box
        sx={{
